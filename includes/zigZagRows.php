...
<div class="row row-1">
    ...
    <span class="contact-anchor"><a href="#contact"><div class="action-button sec-action-button">Let's Do This!</div></a></span>
</div>
...
<div class="row row-2">
    ...
    <span class="contact-anchor"><a href="#contact"><div class="action-button sec-action-button">Don't Be Shy, Talk to Me!</div></a></span>
</div>
<hr class="sec-hr top-space-2">
<div class="row row-3">
    ...
    <span class="contact-anchor"><a href="#contact"><div class="action-button sec-action-button">Help Me Help You!</div></a></span>
</div>